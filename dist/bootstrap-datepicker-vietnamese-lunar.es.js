...
unwrapExports(lib);
var lib_1 = lib.computeDateToLunarDate;
var lib_2 = lib.computeDateFromLunarDate;

const injectLunarCalendar = function(self){
    $(self.picker).find(".day:not(.lunar-day)")
                .map(function(){
                    ...
                    let lunar = lib_1(date.getDate(), date.getMonth()+1, date.getFullYear(), 7);
...
__$styleInject(".datepicker .lunar-day {\n  width: 40px;\n}\n.datepicker .lunar-text {\n  width: auto;\n  height: auto;\n  line-height: inherit;\n  float: right;\n  margin: 0;\n  cursor: inherit;\n  border-radius: 0;\n  font-size: 10px;\n  opacity: 0.6;\n}\n.datepicker table span.gregorian-text {\n  height: 20px;\n  line-height: 20px;\n  float: none;\n}\n");
